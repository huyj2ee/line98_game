...
<html b:css='false' xmlns='http://www.w3.org/1999/xhtml' xmlns:b='http://www.google.com/2005/gml/b' xmlns:data='http://www.google.com/2005/gml/data' xmlns:expr='http://www.google.com/2005/gml/expr'>
    ...
    <body>
        <style>
            div.reset_button{border-radius:25px;background:#73ad21;padding:20px;width:50px;height:25px;text-align:center}
        </style>
        <div id="line98ScoreBoard"></div><br/>
        <div id="line98ResetButton"></div><br/>
